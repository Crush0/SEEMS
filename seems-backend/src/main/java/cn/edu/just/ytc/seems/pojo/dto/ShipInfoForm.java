...
public class ShipInfoForm implements Serializable {
    @Serial
    ...
    private BigDecimal sailedDistance;

    public ShipBaseInfo toShipBaseInfo() {
        ShipBaseInfo shipBaseInfo = new ShipBaseInfo();
        shipBaseInfo.setName(name);
        shipBaseInfo.setType(type);
        shipBaseInfo.setModel(model);
        shipBaseInfo.setOwnerCompany(ownerCompany);
        shipBaseInfo.setManufacturer(manufacturer);
        shipBaseInfo.setShipOriginNumber(shipOriginNumber);
        shipBaseInfo.setMmsi(mmsi);
        shipBaseInfo.setImoNumber(imoNumber);
        shipBaseInfo.setLength(length);
        shipBaseInfo.setLbpLength(lbpLength);
        shipBaseInfo.setDesignLwl(designLwl);
        shipBaseInfo.setMoldedWidth(moldedWidth);
        shipBaseInfo.setWidth(width);
        shipBaseInfo.setMoldedDepth(moldedDepth);
        shipBaseInfo.setDesignDraft(designDraft);
        shipBaseInfo.setMaxDraft(maxDraft);
        shipBaseInfo.setNoLoadDraft(noLoadDraft);
        shipBaseInfo.setMaxLoadDraft(maxLoadDraft);
        shipBaseInfo.setProgress(progress);
        shipBaseInfo.setTowingForce(towingForce);
        shipBaseInfo.setMaxBatteryCapacity(maxBatteryCapacity);
        shipBaseInfo.setSailedDistance(sailedDistance);
        return shipBaseInfo;
    }
}
